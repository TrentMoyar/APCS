...
public class LunchRoom
{
   ...
   {
      ArrayList<Integer>[] waits = new ArrayList<>[4];
      ...
      /* report the data  */
      for(int i = 0; i < 4; i++) {
         for(int j = 0; j < waits[i].size(); j++) {
            if(waits[i].get(j) > longest[i])
               longest[i] = waits[i].get(j);
         }
      }
      
      System.out.println("Senior\t" + waits[0].size() + "\t"
      System.out.println("Junior\t" + waits[1].size() + "\t"
      System.out.println("Sophomore\t" + waits[2].size() + "\t"
      System.out.println("Freshman\t" + waits[3].size() + "\t"
   }
